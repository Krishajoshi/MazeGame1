...
function createWallPuzzle()
{
   ...
   /* wall1 = createSprite(505, 250, 10,100);
    ...
    wall30 = createSprite(535, 450, 40, 10);
    wall30.shapeColor = "fuchsia";
    wall31 = createSprite(530, 430, 50, 10);
    wall31.shapeColor = "peru";
    wall32 = createSprite(490, 430, 50, 10);
    wall32.shapeColor = "chocolate";
    wall33 = createSprite(515, 390, 50, 10);
    wall33.shapeColor = "olive";
    wall34 = createSprite(625,175,10,50);
    wall34.shapeColor =  "orange";
    
    wall35 = createSprite(535, 450, 40, 10);
    wall35.shapeColor = "tan";
    wall36 = createSprite(530, 430, 50, 10);
    wall36.shapeColor = "peru";
    wall37 = createSprite(490, 430, 50, 10);
    wall37.shapeColor = "chocolate";
    wall38 = createSprite(515, 390, 50, 10);
    wall38.shapeColor = "olive";
    wall39 = createSprite(625,175,10,50);
    wall39.shapeColor =  "orange";

    wall40 = createSprite(535, 450, 40, 10);
    wall40.shapeColor = "tan";
    wall41 = createSprite(530, 430, 50, 10);
    wall41.shapeColor = "peru";
    wall42 = createSprite(490, 430, 50, 10);
    wall42.shapeColor = "chocolate";
    wall43 = createSprite(515, 390, 50, 10);
    wall43.shapeColor = "olive";
    wall44 = createSprite(625,175,10,50);
    wall44.shapeColor =  "orange";*/

    //creating the maze
   wall1 = createSprite(550,70,290,20);
  wall1.shapeColor = "lavender";
  wall2 = createSprite(350,240,20,400);
 wall2.shapeColor = "orange";
  wall3 = createSprite(560,260,300,20);
 wall3.shapeColor = "lime";
  wall4 = createSprite(700,155,20,200);
 wall4.shapeColor = "tan";
  wall5 = createSprite(610,390,20,100);
  wall5.shapeColor = "peru";
  wall6 = createSprite(770,430,300,20);
  wall6.shapeColor = "brown";
  wall7 = createSprite(480,160,300,20);
  wall7.shapeColor = "khaki";
  wall8 = createSprite(470,355,270,20);
  wall8.shapeColor = "yellow";
  wall9 = createSprite(921,422,20,300);
  wall9.shapeColor = "green";
  wall10 = createSprite(910,270,200,20);
  wall10.shapeColor = "blue";
  wall11 = createSprite(338,450,300,20);
  wall11.shapeColor = "cyan";
  wall12 = createSprite(915,160,20,200);
  wall12.shapeColor = "plum";
  wall13 = createSprite(350,550,20,110);
  wall13.shapeColor = "orchid";
  wall14 = createSprite(910,60,250,20);
  wall14.shapeColor = "magenta";
  wall16 = createSprite(1100,370,200,20);
  wall16.shapeColor = "red";
  wall19 = createSprite(90,260,20,350);
  wall19.shapeColor = "silver";
  wall20 = createSprite(220,270,240,20);
  wall20.shapeColor = "lavender";
  wall21 = createSprite(800,500,230,20);
  wall21.shapeColor = "teal";
